        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-8 col-md-5">
                    ...
                    <h4><span class="label label-default">于是这里实现了前序遍历树在数据库中的维护,具有以下优点</span></h4>
                    <ul>
                        <li>
                            维护简单,在插入/更新/移动节点时最多只需要3条sql即可完成对整颗树的维护
                            <ol>
                                <li>一条update语句,将所有左权值大于插入位置的节点,相应的左权值减N(N为要插入子树的长度)</li>
                                <li>一条update语句,将所有左权值大于插入位置的节点,相应的右权值加N(N为要插入子树的长度)</li>
                                <li>一条insert语句,写入要添加的节点的数据库记录</li>
                            </ol>
                        </li>
